...
b.prototype.req=function(a){this.w(2,0);this.w(4,247);this.w(8,127);this.w(20,128);this.w(18,a);this.w(2,12);this.w(26,this.r(26)|128);this.w(26,this.r(26)&-129);if(a=this.r(12))throw Error("MRFC522 Request Error "+a);a=this.r(20);return this.ra(18,a)};b.prototype.isNewCard=function(){this.w(26,7);return 0<this.req(38).length};b.prototype.getCardSerial=function(){this.w(26,0);var a=this.req([147,32]);return 5==a.length?a.slice(0,-1):[]};b.prototype.findCards=function(a){this.isNewCard()&&a(this.getCardSerial())};
